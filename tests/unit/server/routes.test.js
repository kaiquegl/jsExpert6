...
describe("#Routes - test site for api response", () => {
  ...
  test(`GET / - should redirect to home page`, async () => {
    ...
    // jest.spyOn(params.response, params.response.writeHead.name).mockReturnValue();
  ...
  test(`POST /undefined - given an inexistent route, it should response with a 404`, async () => {
    const params = TestUtil.defaultHandlerParams();
    params.request.method = "POST";
    params.request.url = `/undefined`;
  ...
  describe("exceptions", () => {
    test("given inexistent fil, it should respond with a 404", async () => {
      const params = TestUtil.defaultHandlerParams();
      params.request.method = "GET";
    ...
    test("given an error, it should respond with a 500", async () => {
      const params = TestUtil.defaultHandlerParams();
      params.request.method = "GET";
      params.request.url = `/index.png`;
